...
@app.route("/average-volume-monthly")
def average_volume_monthly():
    ...
    # Calculate the monthly average of 'Volume'
    monthly_avg_volume = df['Volume'].resample('M').mean().reset_index()

    # Plot the monthly average 'Volume'
    fig = px.line(monthly_avg_volume, x='Date', y='Volume', title="Monthly Average Volume Traded")
